-- Stripe-managed trials: stop inventing trial_ends_at / status=trialing at signup.
-- New accounts start as incomplete until Checkout completes and the webhook syncs Stripe.
...
begin
  ...
  -- Plan intent only. Trial timing/status come from Stripe after Checkout.

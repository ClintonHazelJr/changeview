...
/** Connection + parent-link summary for the Integrations screen. */
export default async function handler(req, res) {
  ...
  const { data: integration, error } = await admin
    .from('integrations')
    .select('id, provider, status, external_workspace_id, external_user_id, external_user_name, updated_at, metadata')
